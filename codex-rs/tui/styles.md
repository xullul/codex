...
- Diff add/delete backgrounds are also an exception: edit blocks may use fixed semantic green/red backgrounds and stronger gutters so inserted/deleted lines remain visually obvious across syntax themes.
