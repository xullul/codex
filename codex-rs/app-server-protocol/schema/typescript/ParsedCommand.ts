...
import type { ParsedCommandActionKind } from "./ParsedCommandActionKind";
 ...
 */
path: string, } | { "type": "list_files", cmd: string, path: string | null, } | { "type": "search", cmd: string, query: string | null, path: string | null, } | { "type": "action", cmd: string, kind: ParsedCommandActionKind, detail: string | null, } | { "type": "unknown", cmd: string, };
